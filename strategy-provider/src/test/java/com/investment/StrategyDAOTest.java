...
import com.strategy.configuration.StrategyProviderConfiguration;
import com.strategy.daos.StrategyDAO;
import com.strategy.models.FundType;
...
@SpringBootTest(classes = { StrategyProviderConfiguration.class})
